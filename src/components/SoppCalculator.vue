  ...
  methods: {
    calcDosage() {
      ...
      if (this.firstTime && this.small) {
        vm.dosageResult = 'Lav dose er 0.5 - 1 g';
      } else if (this.firstTime && this.moderate) {
        vm.dosageResult = 'Moderat dose er 1 - 1.5 g';
      } else if (this.firstTime && this.strong) {
        vm.dosageResult = 'Sterk dose er 1.5 - 2,5 g';
      } else if (!this.firstTime && this.small) {
        vm.dosageResult = 'Lav dose er 1 - 1.5 g';
      } else if (!this.firstTime && this.moderate) {
        vm.dosageResult = 'Moderat dose er 1.5 - 2.5 g';
      } else if (!this.firstTime && this.strong) {
        vm.dosageResult = 'Sterk dose er 2.5 - 5 g';
      }
    },
  },
};
